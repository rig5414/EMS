...
return new class extends Migration
{
    ...
    {
        $reverts = [
            ['name' => 'John Ochieng', 'old_email' => 'john.ochieng@ems.local', 'new_email' => 'john.ochieng@bulkstream.com'],
            ['name' => 'Mary Kipchoge', 'old_email' => 'mary.kipchoge@ems.local', 'new_email' => 'mary.kipchoge@bulkstream.com'],
            ['name' => 'James Mwangi', 'old_email' => 'james.mwangi@ems.local', 'new_email' => 'james.mwangi@bulkstream.com'],
            ['name' => 'Sarah Kariuki', 'old_email' => 'sarah.kariuki@ems.local', 'new_email' => 'sarah.kariuki@bulkstream.com'],
            ['name' => 'Peter Nyambura', 'old_email' => 'peter.nyambura@ems.local', 'new_email' => 'peter.nyambura@bulkstream.com'],
        ];

        DB::transaction(function () use ($reverts) {
            foreach ($reverts as $r) {
                DB::table('employees')
                    ->where('email', $r['new_email'])
                    ->update([
                        'salary' => 0,
                        'email' => $r['old_email'],
                        'updated_at' => now(),
